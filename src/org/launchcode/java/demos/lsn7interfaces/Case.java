...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Peanuts", .25, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("M&Ms", 1.00, new ArrayList<>(Arrays.asList("red #5, dairy")));
        Topping topping3 = new Topping("Chocolate Chips", .75, new ArrayList<>(Arrays.asList("dairy")));
